...
//                MainActivity.lugares.actualiza((int) id, (Lugar) lugar);
                ...
                SelectorFragment.adaptador.setCursor(MainActivity.lugares.extraeCursor());//actualiza cursor
                SelectorFragment.adaptador.notifyItemChanged((int) id); //refresca recyclerview
                finish();
                return true;
