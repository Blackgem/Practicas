...
//                MainActivity.lugares.actualiza((int) id, (Lugar) lugar);
                ...
                MainActivity.adaptador.setCursor(MainActivity.lugares.extraeCursor());//actualiza cursor
                MainActivity.adaptador.notifyItemChanged((int) id); //refresca recyclerview
                finish();
                return true;
